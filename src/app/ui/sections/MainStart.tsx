    ...
    '>
        <div className="container mx-auto ">
            <div className='my-28 lg:w-1/2 relative'>
                <h1 className='font-bold text-clamp40-11-112 font-main lg:text-5xl  leading-normal lg:leading-loose z-10 relative'>Developing IT solutions to scale up your business</h1>
